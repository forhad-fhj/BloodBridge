            ...
            {searchResult.map((donor, index) => {
              ...
              >
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-1 text-xs text-slate-400 break-all p-2 bg-slate-800/50 rounded-lg border border-slate-700 hover:bg-slate-700/50 transition-colors cursor-pointer">
