                    ...
                    >
                      ...
                      <td className="px-3 sm:px-4 py-3 sm:py-4 text-center">
                        <Link
                          ...
                          className="inline-block px-4 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-slate-600 text-slate-300 hover:text-white text-xs sm:text-sm font-semibold rounded-lg shadow-sm transition-all duration-300"
                        >
                          Details
                        </Link>
                      </td>
